...
- Se realizarán un control de los contenidos vistos en clase con el apoyo de alguna lectura bibliográfica que valdrá un 40% de la nota total.

- Los estudiantes realizarán un taller individual de diseño de bases de datos que valdrá un 20% de la nota total.

- Durante el transcurso de la asignatura (y en el marco del Laboratorio de Análisis de Datos) se realizará: Un Trabajo de Taller Colectivo con dos entregas a lo largo del semestre, cada una de las cuales valdrá 20% de la nota final (40% en total).
...
Ver la [Planificación](https://estadistica-descriptiva-uch.netlify.app/schedule)
