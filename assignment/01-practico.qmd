---
title: "Lectura 01. Introducción al lenguaje R"
date: ""
lang: es
output:
...
2. Cómo establecer un flujo de trabajo mediante **scripts** y **Rprojects** siguiendo el protocolo [IPO](https://lisa-coes.com/ipo-data/)

3. Cómo crear un proyecto de R (R.proyect)

4. Cómo crear un script (hoja) en R
...
### 5.1 Primera parte de la estructura de datos: *columnas y objetos*
...
### 5.2 Segunda parte de la estructura de datos: *filas y funcionamiento de una base de datos*
...
### 5.3 Entonces, dentro de la investigación sociológica y estadística lo que hacemos es:
