...
**Datos**: Se utilizan los datos del Estudio Longitudinal Social de Chile (ELSOC) realizado por [COES](https://conferencias.coes.cl/encuesta-panel/). Recuerden que siempre es importante trabajar con el manual/libro de códigos de las bases de datos. El manual de la ELSOC 2022 lo pueden encontrar [aquí](../data/Listado-de-Variables-ELSOC.xlsx).
...
*Importe* los datos a utilizar. Para ello descargue la base de datos ELSOC 2022 en el siguiente [link](../data/ELSOC_W06_v1.0_SPSS.sav). 
